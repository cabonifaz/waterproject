...
export async function POST(request: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    return NextResponse.json({
      success: true,
      data: resultado,
      message: `${resultado.epicasCreadas} épica(s) nueva(s), ${resultado.epicasReactivadas} épica(s) reactivada(s), ${resultado.huCreadas} HU creada(s), ${resultado.huReactivadas} reactivada(s), ${resultado.huOmitidas} omitida(s)`,
