// app/api/tareas-matrices/[id]/miembros/route.ts
// Asigna/desasigna (toggle) un miembro del proyecto a una tarea matriz.
...
export async function POST(request: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    await miembrosService.asignarMiembroTareaMatriz(tareaMatrizId, miembro_id);
    ...
    console.error('Error asignando miembro a tarea matriz:', error);
    return NextResponse.json(
